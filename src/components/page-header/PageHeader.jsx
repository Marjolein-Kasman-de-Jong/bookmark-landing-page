      ...
      <nav>
        ...
        <ul className='sidebar'>
          <div className='wrapper-1'>
            <li>
              <a href='#'>
                <svg width='149' height='25' xmlns='http://www.w3.org/2000/svg'>
                  <g fill='none' fillRule='evenodd'>
                    ...
                    <g>
                      ...
                      <path d='M9 9v10l3.54-3.44L16.078 19V9a2 2 0 0 0-2-2H11a2 2 0 0 0-2 2z' fill='#252B46' />
                    </g>
                  </g>
                </svg>
              </a>
          ...
          <div className='wrapper-2'>
            ...
            <li>
              <a href='#'>
                <Button type='login' buttonText='login' />
              </a>
            </li>
            <li>
              <a href='#'>
